...
local _0x8=_0x2:WaitForChild("\77\111\100\117\108\101\115"):WaitForChild("\78\101\116")local _0x9=_0x8:WaitForChild("\82\69\47\82\101\103\105\115\116\101\114\65\116\116\97\99\107")local _0xA=_0x8:WaitForChild("\82\69\47\82\101\103\105\115\116\101\114\72\105\116")
local function _0xB()pcall(function()local c=_0x1.LocalPlayer.Character;if not(c and c:FindFirstChild("\72\117\109\97\110\111\105\100\82\111\111\116\80\97\114\116"))then return end
local p=c.HumanoidRootPart.Position;local t={};for _,f in pairs({workspace:FindFirstChild("\69\110\101\109\105\101\115"),workspace:FindFirstChild("\67\104\97\114\97\99\116\101\114\115")})do
if f then for _,v in pairs(f:GetChildren())do if v:FindFirstChild("\72\117\109\97\110\111\105\100")and v.Humanoid.Health>0 and v:FindFirstChild("\72\117\109\97\110\111\105\100\82\111\111\116\80\97\114\116")then
if(v.HumanoidRootPart.Position-p).Magnitude<=_G.FastAttackConfig.Distance then table.insert(t,v)end end end end end
if #t>0 then local tp=t[1].HumanoidRootPart;local ah={[1]=tp,[2]={}};for i,v in pairs(t)do if not ah[1]then ah[1]=v.Head end;ah[2][i]={v,v.HumanoidRootPart}end
local tl=c:FindFirstChildOfClass("\84\111\111\108")if tl then local fr=tl:FindFirstChild("\76\101\102\116\67\108\105\99\107\82\101\109\111\116\101") or tl:FindFirstChild("\82\101\109\111\116\101") or tl:FindFirstChildOfClass("\82\101\109\111\116\101\69\118\101\110\116")
if fr then local dr=(tp.Position-p).Unit;fr:FireServer(dr,1)end end;_0x9:FireServer(0);for i=1,_G.FastAttackConfig.BurstCount do _0xA:FireServer(unpack(ah))end end end)end
